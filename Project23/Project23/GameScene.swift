...
//  Project23
//
//  Created by meekam okeke on 12/7/20.
//
import AVFoundation
import SpriteKit
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        //sets the gravity of our physics simulation to be less than the earth's default of -9.8
        physicsWorld.gravity = CGVector(dx: 0, dy: -6)
        //sets the speed at which all things within the game move
    ...
    func redrawActiveSlice(){
        ...
        //go to the very first slice point we have on the screen
